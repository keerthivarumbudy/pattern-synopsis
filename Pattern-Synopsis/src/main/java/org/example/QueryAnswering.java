...
public class QueryAnswering {
    ...
    public static List<String> topKWithoutSequentialGeneration(Integer numberOfEvents, List<Integer> windows, Sketch sketch, int k) throws IOException {
        ...
        for(List<String> pattern: patterns){
            ...
            patternMap.putIfAbsent(pattern, upperBound);
        }
        // get topK patterns
